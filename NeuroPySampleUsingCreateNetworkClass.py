...
# fit the data
result = networks.fit(training_data, answer, 1000, 2)


print(networks.batch_array, "\n")
print(networks.answer_key_batch_array, "\n")



print(networks.predict(train_data_01))
